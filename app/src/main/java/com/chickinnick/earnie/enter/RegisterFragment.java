...
public class RegisterFragment extends Fragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRegisterBinding.signUpFacebook.setOnClickListener(this);
        ...
        fragmentRegisterBinding.signUpFacebook.setTypeface(typeface);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.sign_up:
                ...
                onFragmentActionListener.onSignUp(builder.createUser());
                break;
            case R.id.sign_up_facebook:
                onFragmentActionListener.onLogInFB();
                break;
